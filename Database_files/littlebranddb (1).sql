...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2020 at 06:31 AM
...
--
-- Table structure for table `cust_order_item_men`
--

CREATE TABLE `cust_order_item_men` (
  `Order_Item_ID` int(11) NOT NULL,
  `Order_ID` int(11) DEFAULT NULL,
  `Product_ID` int(11) NOT NULL,
  `Quantity` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `cust_order_item_men`
--
...
ALTER TABLE `cust_order_item`
  ...
  ADD KEY `fk_product_order_women` (`Product_ID`);

--
-- Indexes for table `cust_order_item_men`
--
ALTER TABLE `cust_order_item_men`
  ADD PRIMARY KEY (`Order_Item_ID`),
  ADD KEY `fk_product_order_men` (`Product_ID`);
...
--
ALTER TABLE `cust_order_item`
  ADD CONSTRAINT `fk_product_order_women` FOREIGN KEY (`Product_ID`) REFERENCES `women_inventory` (`Product_ID`);

--
-- Constraints for table `cust_order_item_men`
--
ALTER TABLE `cust_order_item_men`
  ADD CONSTRAINT `fk_product_order_men` FOREIGN KEY (`Product_ID`) REFERENCES `men_inventory` (`Product_ID`);
