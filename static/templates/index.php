    ...
    <!--<nav class="navbar navbar-expand-lg navbar-light bg-light"><a href="#" class="navbar-brand d-lg-none">Gridbox</a><button type="button" data-toggle="collapse" data-target="#navigations-02"
        ...
        <div id="navigations-02" class="collapse navbar-collapse justify-content-md-center">
            <ul class="navbar-nav justify-content-end">
                <li class="nav-item mr-2"></li><a href="#" class="nav-link active">Collections<span class="sr-only">(current)</span></a><a href="#" class="nav-link">Women</a><a href="#"
                    class="nav-link">Men</a><a href="#" class="nav-link">Kids</a><a href="#" class="nav-link">Brands</a><a href="#" class="nav-link">Contact</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 mb-5"><a href="javascript:void(0);" class="card product-card-com h-100">
                        <div class="card-tag card-tag-dark card-tag-top-right card-tag-lg">$956</div><img src="https://i.ebayimg.com/images/g/iIMAAOxy14VRRYuk/s-l300.jpg" alt="..."
                            class="card-img-top" />
